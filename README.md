This was an extension of a project I did as an undergrad. The original requirements required the user to put in a file footprent to test against. This extension reads against a list of real viruses.
